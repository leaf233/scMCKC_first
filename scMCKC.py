    ...
    def fit(self, X, X_raw, sf,
        ...
        for epoch in range(num_epochs):
            ...
            for batch_idx in range(num_batch):
                ...
                loss = cluster_loss + recon_loss + kmeans_loss * 0.00015 + similarity_loss
                loss.backward()
                optimizer.step()
                ...
                similarity_loss_val += similarity_loss.data * len(inputs)
                train_loss = cluster_loss_val + recon_loss_val + kmeans_loss_val * 0.00015 + similarity_loss_val
